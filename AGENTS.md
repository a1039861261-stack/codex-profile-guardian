...
- Keep Codex and Claude as separate platform workspaces. Codex primary navigation remains Overview, Accounts, Chat Protection, Backups, Logs, Settings; Claude starts with one sparse connection-status page.
