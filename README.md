...
- `v1.9.0` 开发分支新增正式 GitHub Release 自动检查与预下载、安装前显式确认、版本化资产与 SHA-256 校验，并重做额度摘要、刷新反馈、账号按钮和当前卡片视觉层级；尚未构建或发布 Release。
...
- GitHub 仓库当前为私有仓库；源码变更通过分支和 Pull Request 审核，客户端更新只跟随正式 Release，不跟随普通提交。
